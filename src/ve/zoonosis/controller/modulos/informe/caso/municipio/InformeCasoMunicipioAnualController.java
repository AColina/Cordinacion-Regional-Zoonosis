...
import ve.zoonosis.vistas.modulos.informes.caso.municipio.InformeCasoMunicipioAnual;
 ...
 * @author Gustavo
 */
public class InformeCasoMunicipioAnualController extends InformeCasoMunicipioAnual {

    private static final Logger LOG = Logger.getLogger(InformeCasoMunicipioAnualController.class.getName());
    private RequestBuilder rb;
    private JFileChooser archivo;
    private PDFCreator pdfc = new PDFCreator();
    private DecimalFormat decimalFormat = new DecimalFormat("#.##");

    public InformeCasoMunicipioAnualController() {
        inicializar();
    }
            ...
            mButton1.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    try {
                        ...
                        Logger.getLogger(InformeCasoMunicipioAnualController.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            });
    ...
    private void obtenerInforme() throws IOException {
        ...
        try {
            ...
            rb = new RequestBuilder("services/funcionales/AnimalWs/ObtenerListaPorYearDeCasoPorMunicipio.php",
                    new HashMap<String, Object>() {
                        {
            ...
            if (valores == null || valores.isEmpty()) {
                ...
                pdfc.addLeftText("Informe sobre los casos en el año " + years.getSelectedItem() + " en el Municipio " + municipios.getSelectedItem()
