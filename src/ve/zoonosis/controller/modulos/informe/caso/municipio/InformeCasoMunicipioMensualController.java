 ...
 * @author Gustavo
 */
public class InformeCasoMunicipioMensualController extends InformeCasoMunicipioMensual {
    ...
    public InformeCasoMunicipioMensualController() {
        inicializar();
    }
            ...
            mButton1.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    try {
                        ...
                        Logger.getLogger(InformeCasoMunicipioMensualController.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            });
