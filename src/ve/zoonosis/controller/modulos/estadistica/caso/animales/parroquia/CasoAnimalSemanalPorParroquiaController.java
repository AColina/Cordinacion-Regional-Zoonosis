 ...
 * @author Kelvin López
 */
public class CasoAnimalSemanalPorParroquiaController extends CasoAnimalSemanaPorParroquia {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public CasoAnimalSemanalPorParroquiaController() {
        inicializar();
    ...
    private void obtenerEstadistica() {
        ...
        try {
            ...
            rb = new RequestBuilder("services/funcionales/AnimalWs/ObtenerListaAnimalesPorSemanaDeCasoPorParroquia.php",
                    new HashMap<String, Object>() {
                        {
