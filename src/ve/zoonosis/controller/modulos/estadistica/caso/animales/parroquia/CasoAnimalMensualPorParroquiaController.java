...
import ve.zoonosis.vistas.modulos.estadistica.caso.animales.parroquia.CasoAnimalMensualPorParroquia;
 ...
 * @author Kelvin López
 */
public class CasoAnimalMensualPorParroquiaController extends CasoAnimalMensualPorParroquia {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public CasoAnimalMensualPorParroquiaController() {
        inicializar();
    ...
    private void obtenerEstadistica() {
        ...
        try {
            ...
            rb = new RequestBuilder("services/funcionales/AnimalWs/ObtenerListaAnimalesPorMesDeCasoPorParroquia.php",
            ...
            java.util.logging.Logger.getLogger(CasoAnimalMensualPorParroquiaController.class.getName()).log(Level.SEVERE, null, ex);
        }
