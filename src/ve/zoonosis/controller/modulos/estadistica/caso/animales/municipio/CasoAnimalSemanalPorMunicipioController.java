...
import ve.zoonosis.vistas.modulos.estadistica.caso.animales.municipio.CasoAnimalSemanaPorMunicipio;
 ...
 * @author Kelvin López
 */
public class CasoAnimalSemanalPorMunicipioController extends CasoAnimalSemanaPorMunicipio {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public CasoAnimalSemanalPorMunicipioController() {
        inicializar();
    ...
    private void obtenerEstadistica() {
        ...
        try {
            ...
            rb = new RequestBuilder("services/funcionales/AnimalWs/ObtenerListaAnimalesPorSemanaDeCasoPorMunicipio.php",
                    new HashMap<String, Object>() {
                        {
