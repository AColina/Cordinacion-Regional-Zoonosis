 ...
 * @author Kelvin López
 */
public class CasoAnimalDiarioPorMunicipioController extends CasoAnimalDiarioPorMunicipio {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public CasoAnimalDiarioPorMunicipioController() {
        inicializar();
    ...
    private void obtenerEstadistica() {
        ...
        try {
            ...
            rb = new RequestBuilder("services/funcionales/AnimalWs/ObtenerListaAnimalesPorFechaDeCasoPorMunicipio.php",
            ...
            java.util.logging.Logger.getLogger(CasoAnimalDiarioPorMunicipioController.class.getName()).log(Level.SEVERE, null, ex);
        }
