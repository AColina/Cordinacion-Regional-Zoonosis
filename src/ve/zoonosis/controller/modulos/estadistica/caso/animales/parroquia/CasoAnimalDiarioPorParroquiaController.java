 ...
 * @author Kelvin López
 */
public class CasoAnimalDiarioPorParroquiaController extends CasoAnimalDiarioPorParroquia {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public CasoAnimalDiarioPorParroquiaController() {
        inicializar();
    ...
    private void obtenerEstadistica() {
        ...
        try {
            ...
            rb = new RequestBuilder("services/funcionales/AnimalWs/ObtenerListaAnimalesPorFechaDeCasoPorParroquia.php",
            ...
            java.util.logging.Logger.getLogger(CasoAnimalDiarioPorParroquiaController.class.getName()).log(Level.SEVERE, null, ex);
        }
