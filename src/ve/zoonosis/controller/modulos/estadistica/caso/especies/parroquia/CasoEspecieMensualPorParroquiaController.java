...
import ve.zoonosis.vistas.modulos.estadistica.caso.especies.parroquia.CasoEspecieMensualPorParroquia;
 ...
 * @author Kelvin López
 */
public class CasoEspecieMensualPorParroquiaController extends CasoEspecieMensualPorParroquia {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public CasoEspecieMensualPorParroquiaController() {
        inicializar();
    ...
    private void obtenerEstadistica() {
        ...
        try {
            ...
            rb = new RequestBuilder("services/funcionales/EspecieWs/ObtenerListaEspeciesPorMesDeCasoPorParroquia.php",
            ...
            java.util.logging.Logger.getLogger(CasoEspecieMensualPorParroquiaController.class.getName()).log(Level.SEVERE, null, ex);
        }
