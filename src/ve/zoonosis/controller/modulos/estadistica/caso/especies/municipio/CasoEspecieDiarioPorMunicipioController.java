...
import ve.zoonosis.vistas.modulos.estadistica.caso.especies.municipio.CasoEspecieDiarioPorMunicipio;
 ...
 * @author Kelvin López
 */
public class CasoEspecieDiarioPorMunicipioController extends CasoEspecieDiarioPorMunicipio {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public CasoEspecieDiarioPorMunicipioController() {
        inicializar();
    ...
    private void obtenerEstadistica() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CasoEspecieDiarioPorMunicipioController.class.getName()).log(Level.SEVERE, null, ex);
        }
