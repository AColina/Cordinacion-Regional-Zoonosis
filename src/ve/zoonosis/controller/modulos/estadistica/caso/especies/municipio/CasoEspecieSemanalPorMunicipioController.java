 ...
 */
package ve.zoonosis.controller.modulos.estadistica.caso.especies.municipio;
...
import ve.zoonosis.vistas.modulos.estadistica.caso.especies.municipio.CasoEspecieSemanaPorMunicipio;
 ...
 * @author Kelvin López
 */
public class CasoEspecieSemanalPorMunicipioController extends CasoEspecieSemanaPorMunicipio {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public CasoEspecieSemanalPorMunicipioController() {
        inicializar();
    ...
    private void buscarSemanas() {
        try {
            ...
            java.util.logging.Logger.getLogger(CasoEspecieSemanalPorMunicipioController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void obtenerEstadistica() {
        ...
        try {
            ...
            rb = new RequestBuilder("services/funcionales/EspecieWs/ObtenerListaEspeciesPorSemanaDeCasoPorMunicipio.php",
                    new HashMap<String, Object>() {
                        {
