...
import ve.zoonosis.vistas.modulos.estadistica.caso.especies.parroquia.CasoEspecieSemanaPorParroquia;
 ...
 * @author Kelvin López
 */
public class CasoEspecieSemanalPorParroquiaController extends CasoEspecieSemanaPorParroquia {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public CasoEspecieSemanalPorParroquiaController() {
        inicializar();
    ...
    private void buscarSemanas() {
        try {
            ...
            java.util.logging.Logger.getLogger(CasoEspecieSemanalPorParroquiaController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void obtenerEstadistica() {
        ...
        try {
            ...
            rb = new RequestBuilder("services/funcionales/EspecieWs/ObtenerListaEspeciesPorSemanaDeCasoPorParroquia.php",
                    new HashMap<String, Object>() {
                        {
