...
import ve.zoonosis.vistas.modulos.estadistica.caso.especies.municipio.CasoEspecieMensualPorMunicipio;
 ...
 * @author Kelvin López
 */
public class CasoEspecieMensualPorMunicipioController extends CasoEspecieMensualPorMunicipio {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public CasoEspecieMensualPorMunicipioController() {
        inicializar();
...
//        dia.setDate(new Date());
    ...
    private void obtenerEstadistica() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CasoEspecieMensualPorMunicipioController.class.getName()).log(Level.SEVERE, null, ex);
        }
