 ...
 */
package ve.zoonosis.controller.modulos.estadistica.caso.especies.parroquia;

import ve.zoonosis.controller.modulos.estadistica.caso.animales.parroquia.*;
...
import ve.zoonosis.vistas.modulos.estadistica.caso.animales.parroquia.CasoAnimalDiarioPorParroquia;
import ve.zoonosis.vistas.modulos.estadistica.caso.especies.parroquia.CasoEspecieDiarioPorParroquia;
 ...
 * @author Kelvin López
 */
public class CasoEspecieDiarioPorParroquiaController extends CasoEspecieDiarioPorParroquia {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public CasoEspecieDiarioPorParroquiaController() {
        inicializar();
    ...
    private void obtenerEstadistica() {
        ...
        try {
            ...
            rb = new RequestBuilder("services/funcionales/EspecieWs/ObtenerListaEspeciesPorFechaDeCasoPorParroquia.php",
            ...
            java.util.logging.Logger.getLogger(CasoEspecieDiarioPorParroquiaController.class.getName()).log(Level.SEVERE, null, ex);
        }
