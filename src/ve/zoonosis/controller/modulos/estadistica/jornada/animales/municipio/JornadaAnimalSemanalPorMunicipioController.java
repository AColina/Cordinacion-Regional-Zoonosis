 ...
 * @author Kelvin López
 */
public class JornadaAnimalSemanalPorMunicipioController extends JornadaAnimalSemanaPorMunicipio {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public JornadaAnimalSemanalPorMunicipioController() {
        inicializar();
    ...
    private void buscarSemanas() {
        try {
            ...
            java.util.logging.Logger.getLogger(JornadaAnimalSemanalPorMunicipioController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
