 ...
 */
package ve.zoonosis.controller.modulos.estadistica.jornada.animales.parroquia;
...
import ve.zoonosis.vistas.modulos.estadistica.jornada.animales.parroquia.JornadaAnimalDiarioPorParroquia;
 ...
 * @author Kelvin López
 */
public class JornadaAnimalDiarioPorParroquiaController extends JornadaAnimalDiarioPorParroquia {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public JornadaAnimalDiarioPorParroquiaController() {
        inicializar();
    ...
    private void obtenerEstadistica() {
        ...
        try {
            ...
            rb = new RequestBuilder("services/funcionales/AnimalWs/ObtenerListaAnimalesPorFechaDeJornadaPorParroquia.php",
            ...
            java.util.logging.Logger.getLogger(JornadaAnimalDiarioPorParroquiaController.class.getName()).log(Level.SEVERE, null, ex);
        }
