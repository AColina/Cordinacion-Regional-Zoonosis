 ...
 * @author Kelvin López
 */
public class JornadaAnimalSemanalPorParroquiaController extends JornadaAnimalSemanaPorParroquia {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public JornadaAnimalSemanalPorParroquiaController() {
        inicializar();
    ...
    private void obtenerEstadistica() {
        ...
        try {
            ...
            rb = new RequestBuilder("services/funcionales/AnimalWs/ObtenerListaAnimalesPorSemanaDeJornadaPorParroquia.php",
                    new HashMap<String, Object>() {
                        {
