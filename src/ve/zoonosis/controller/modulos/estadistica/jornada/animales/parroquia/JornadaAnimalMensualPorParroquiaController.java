 ...
 * @author Kelvin López
 */
public class JornadaAnimalMensualPorParroquiaController extends JornadaAnimalMensualPorParroquia {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public JornadaAnimalMensualPorParroquiaController() {
        inicializar();
    ...
    private void obtenerEstadistica() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JornadaAnimalMensualPorParroquiaController.class.getName()).log(Level.SEVERE, null, ex);
        }
