 ...
 * @author Kelvin López
 */
public class JornadaEspecieMensualPorParroquiaController extends JornadaEspecieMensualPorParroquia {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public JornadaEspecieMensualPorParroquiaController() {
        inicializar();
    ...
    private void obtenerEstadistica() {
        ...
        try {
            ...
            rb = new RequestBuilder("services/funcionales/EspecieWs/ObtenerListaEspeciesPorMesDeJornadaPorParroquia.php",
            ...
            java.util.logging.Logger.getLogger(JornadaEspecieMensualPorParroquiaController.class.getName()).log(Level.SEVERE, null, ex);
        }
