 ...
 */
package ve.zoonosis.controller.modulos.estadistica.jornada.especies.parroquia;
...
import ve.zoonosis.vistas.modulos.estadistica.jornada.especies.parroquia.JornadaEspecieSemanaPorParroquia;
 ...
 * @author Kelvin López
 */
public class JornadaEspecieSemanalPorParroquiaController extends JornadaEspecieSemanaPorParroquia {

    private static final Logger LOG = Logger.getLogger(NuevoCasoController.class);
    private RequestBuilder rb;

    public JornadaEspecieSemanalPorParroquiaController() {
        inicializar();
    ...
    public final void inicializar() {
       ...
       // dia.setDate(new Date());
        ...
        try {
            ...
            List<Parroquia> listaMunicipios = rb.ejecutarJson(List.class, Parroquia.class);
            if (listaMunicipios == null || listaMunicipios.isEmpty()) {
                mButton1.setEnabled(false);
            } else if (parroquias != null) {
                parroquias.setModel(new DefaultComboBoxModel(listaMunicipios.toArray()));
    ...
    private void buscarSemanas() {
        try {
            ...
            java.util.logging.Logger.getLogger(JornadaEspecieSemanalPorParroquiaController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void obtenerEstadistica() {
        ...
        try {
            ...
            rb = new RequestBuilder("services/funcionales/EspecieWs/ObtenerListaEspeciesPorSemanaDeJornadaPorParroquia.php",
                    new HashMap<String, Object>() {
                        {
            ...
            if (valores == null || valores.isEmpty()) {
                ...
                for (HashMap valor : ordValores) {
                    ChartObject chart = new ChartObject(valor.get("nombre").toString(), 
                            Double.parseDouble(valor.get("cantidad").toString()), rc.obtenerColorAleatorio());
                    lista.add(chart);
